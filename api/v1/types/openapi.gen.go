...
type Account struct {
	...
	Nonce           common.BigInt    `json:"nonce"`
...
type DebondingDelegationList struct {
	Delegations []DebondingDelegation `json:"delegations"`
}
...
type TxVolume struct {
	// Date The date for this daily transaction volume measurement.
...
type TxVolumeList struct {
	// Volumes The list of daily transaction volumes.
	Volumes []TxVolume `json:"volumes"`
}
...
type Validator struct {
	...
	// Name The name of this Validator.
