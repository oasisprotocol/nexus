...
testCases=(
  ...
  'validator_by_entity_id                     /v1/consensus/validators?id=HPeLbzc88IoYEP0TC4nqSxfxdPCPjduLeJqFvmxFye8%3D'
  'validator_by_node_id                       /v1/consensus/validators?id=wqd9Yy3n7TWKfYRn2bI9Hd6%2F623CfC7NCUoRbQ5UkR8%3D'
  ...
  'emerald_txs_by_related_account             /v1/emerald/transactions?rel=oasis1qp3r8hgsnphajmfzfuaa8fhjag7e0yt35cjxq0u4'
  'emerald_txs_by_related_account_and_method  /v1/emerald/transactions?rel=oasis1qp3r8hgsnphajmfzfuaa8fhjag7e0yt35cjxq0u4&method=consensus.Withdraw'
)
