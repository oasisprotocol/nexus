...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- Module roflmarket -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
-- Added in 24_runtime_roflmarket.up.sql
...
--   FOREIGN KEY (runtime, provider) REFERENCES chain.roflmarket_providers(runtime, address),
...
--   FOREIGN KEY (runtime, offer_id) REFERENCES chain.roflmarket_offers(runtime, id),
