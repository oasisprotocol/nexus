...
(
  ...
  -- likely_native_transfer BOOLEAN NOT NULL DEFAULT FALSE -- Added in 16_related_runtime_transactions_method_denorm.up.sql.
);
...
-- Added in 16_related_runtime_transactions_method_denorm.up.sql.
...
(
  ...
  -- method TEXT, -- Added in 16_related_runtime_transactions_method_denorm.up.sql.
  -- likely_native_transfer BOOLEAN NOT NULL DEFAULT FALSE -- Added in 16_related_runtime_transactions_method_denorm.up.sql.
