...
-- Added in 36_runtime_delegations.up.sql.
...
--     delegatee oasis_addr NOT NULL, -- This could be FK chain.accounts(address), but we don't want runtime-consensus references at the moment (cannot test runtme analyzer without consensus).
