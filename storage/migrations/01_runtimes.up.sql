...
(
  ...
  related_accounts TEXT[] -- Removed in 07_runtime_events_related_accounts.up.sql.
);
...
-- Added in 07_runtime_events_related_accounts.up.sql.
...
--     PRIMARY KEY (runtime, round, event_index, related_account),
-- );
