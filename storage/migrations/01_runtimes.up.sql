...
(
  ...
  -- abi when available.
  abi_parsed_at TIMESTAMP WITH TIME ZONE -- Updated in 20_runtime_abi_parsed_at.up.sql: NOT NULL DEFAULT '0001-01-01'
...
CREATE INDEX ix_runtime_transactions_to_abi_parsed_at ON chain.runtime_transactions (runtime, "to", abi_parsed_at); -- Removed in 20_runtime_abi_parsed_at.up.sql.
-- Added in 20_runtime_abi_parsed_at.up.sql.
...
(
  ...
  -- abi when available.
  abi_parsed_at TIMESTAMP WITH TIME ZONE -- Added in 20_runtime_abi_parsed_at.up.sql. NOT NULL DEFAULT '0001-01-01'.
);
