...
(
  ...
  block_hash HEX64 NOT NULL,  -- NULL in 19_block_meta.up.sql
  time       TIMESTAMP WITH TIME ZONE NOT NULL,  -- NULL in 19_block_meta.up.sql
  num_txs    UINT31 NOT NULL,  -- NULL in 19_block_meta.up.sql

  -- State Root Info
  namespace TEXT NOT NULL,  -- NULL in 19_block_meta.up.sql
  version   UINT63 NOT NULL,  -- NULL in 19_block_meta.up.sql
  type      TEXT NOT NULL,  -- "invalid" | "state-root" | "io-root"; From https://github.com/oasisprotocol/oasis-core/blob/f95186e3f15ec64bdd36493cde90be359bd17da8/go/storage/mkvs/node/node.go#L68-L68  -- NULL in 19_block_meta.up.sql
  root_hash HEX64 NOT NULL,  -- NULL in 19_block_meta.up.sql

  beacon     BYTEA,
  metadata   JSONB

  -- added in 19_block_meta.up.sql
