...
(
  ...
  block_hash HEX64 NOT NULL,  -- NULL in 28_block_meta.up.sql
  time       TIMESTAMP WITH TIME ZONE NOT NULL,  -- NULL in 28_block_meta.up.sql
  num_txs    UINT31 NOT NULL,  -- NULL in 28_block_meta.up.sql

  -- State Root Info
  namespace TEXT NOT NULL,  -- NULL in 28_block_meta.up.sql
  version   UINT63 NOT NULL,  -- NULL in 28_block_meta.up.sql
  root_hash HEX64 NOT NULL, -- Renamed to `state_root` in 21_consensus_block.up.sql, NULL in 28_block_meta.up.sql
